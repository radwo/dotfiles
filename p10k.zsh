# Generated by Powerlevel10k configuration wizard on 2021-05-28 at 22:45 CEST.
# Based on romkatv/powerlevel10k/config/p10k-lean-8colors.zsh, checksum 9387.
# Wizard options: powerline, unicode, lean_8colors, 24h time, 2 lines, dotted, no frame,
# blue-ornaments, sparse, fluent, transient_prompt, instant_prompt=verbose.
...
() {
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_SHOW_ON_COMMAND='kubectl|helm|kubens|kubectx|oc|istioctl|kogito|k9s|helmfile|fluxctl|stern|kubessh'
